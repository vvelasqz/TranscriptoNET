...
This notebook contains code to make a phylogenetic tree with a heatmap using ggtree

## Dataset description

This project contains a phylogenetic tree of the homeobox familly in barley and a set of log1 foldchanges in their expression dataset
